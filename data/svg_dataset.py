...
from Chart2SVG.svglib import replace_gradient_tags, remove_svg_tag, apply_g_attributes_to_children
from Chart2SVG.utils import path_exists
from Chart2SVG.data.semantic_tokens import svg2syntactic
