...
SVG_DESC_T1 = "[<|START_OF_SVG|>][<|path|>][<|d=|>] [<|moveto_abs|>]63.6 118.8 [<|curveto_rel|>] -27.9 0 -58 -17.5 -58 -55.9 [<|smooth_curveto_rel|>] 30.1 -55.9 58 -55.9 [<|curveto_rel|>] -10.6 9.3 -25 14.5 -40.4 14.5 [<|close_path|>][<|fill=|>]#fde030[<|/path|>][<|END_OF_SVG|>]"
